import { TradingModel } from "@/lib/oldtypes";
...
export const tradingModels: TradingModel[] = [
  {
    ...
    name: "CCM + Trix v1.0",
    explanation:
      "A momentum-based strategy combining Consecutive Candle Momentum (CCM) with the TRIX oscillator. This model identifies strong directional moves when multiple candles align in the same direction while TRIX confirms the trend strength. Best used on lower timeframes (5m-15m) for day trading.",
    rules: [
  ...
  },
  {
    ...
    name: "CCM + Trix v2.0",
    explanation:
      "An enhanced version of v1.0 with additional HTF (Higher Timeframe) alignment filter. This model requires the higher timeframe trend to be in the same direction as the setup, significantly improving win rate. Ideal for 5m-15m entries with 1h-4h trend confirmation.",
    rules: [
  ...
  },
  {
    ...
    name: "CT Strategy v3",
    explanation:
      "A comprehensive trend-following strategy (Consolidated Trend) that combines multiple timeframe analysis with support/resistance zones. This model excels at catching swing trades and works best on 1h-4h timeframes for multi-day holds.",
    rules: [
  ...
  },
  {
    ...
    explanation:
      "A classic breakout strategy that waits for a retest of broken structure before entering. This patient approach filters out false breakouts and provides better risk-reward entries. Works across all timeframes but particularly effective on 15m-1h for intraday setups.",
    rules: [
